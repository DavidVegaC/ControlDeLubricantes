...
import com.assac.controldelubricantes.Entities.MigrationErrorEntity;
...
public class Const {
    ...
    ///  IP Servidor Web
    public static String IP_SERVER = "192.168.1.47";
    ...
    public static final String HTTP_SITE = "http://" + IP_SERVER + "/";
    ...
    public static int CONTADOR_LECTURAS_NFC = 0;
